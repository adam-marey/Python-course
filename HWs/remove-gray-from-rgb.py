...
# Each sub-color's value can range from 0 to 255. Thus (255, 0, 0) is bright red, (130, 0, 130) is a medium purple, (0, 0, 0) is black, (255, 255, 255) is white, and (40, 40, 40) is a dark gray.
...
min_value = red_value
if green_value < min_value:
    min_value = green_value
if blue_value < min_value:
    min_value = blue_value

print(red_value - min_value, green_value - min_value, blue_value - min_value)